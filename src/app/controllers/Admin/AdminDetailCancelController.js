...
class AdminDetailCancelController {
    async adminDetailCancel ( req, res, next) {
        ...
        return res.render('admin/detail-cancel',{order:order,listAddress:listAddress,staffShip:staffShip, layout:'admin'});
    }
...
module.exports = new AdminDetailCancelController;