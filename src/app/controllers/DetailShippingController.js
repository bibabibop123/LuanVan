...
class DetailshippingController {
    async DetailShipping ( req, res, next) {
        ...
        return res.render('detailShipping',{order:order,listAddress:listAddress,staffShip:staffShip});
    }
...
module.exports = new DetailshippingController;