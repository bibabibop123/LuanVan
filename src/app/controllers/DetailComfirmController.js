...
class DetailComfirmController {
    async DetailComfirm ( req, res, next) {
        ...
        return res.render('detailComfirm',{order:order,listAddress:listAddress,staffShip:staffShip});
    }
...
module.exports = new DetailComfirmController;