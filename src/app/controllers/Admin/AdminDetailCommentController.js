...
class AdminDetailCommentController {
    async adminDetailComment ( req, res, next) {
        ...
        return res.render('admin/detailComment',{order:order, listAddress:listAddress, staffShip:staffShip, layout:'admin'});
    }
    
    async adminFeedback(req,res,next){
...
module.exports = new AdminDetailCommentController;