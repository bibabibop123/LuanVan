...
class AdminDetailComfirmShipperController {
    async adminDetailComfirmShipper ( req, res, next) {
        ...
        console.log('staffShip', order);
        const shipper = await StaffShip.findById(order.staffShip);
        return res.render('shipper/detailComfirmShipper',{order:order,listAddress:listAddress,staffShip:staffShip, layout:'shipperLayout'});
    }
...
module.exports = new AdminDetailComfirmShipperController;